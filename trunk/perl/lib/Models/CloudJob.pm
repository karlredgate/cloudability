...
Models::CloudJob - Manages jobs to be run by the Server::CloudEngine

=head1 VERSION

This document refers to version 1.0 of Models::CloudJob, released Nov 29, 2008

=head1 DESCRIPTION

Models::CloudJob manages the details for jobs to be run by Server::CloudEngine.
Be sure to call the class static method connect() before using Models::CloudJob
...
sub submit
{
    ...
    my $cloud_job = Models::CloudJob->new(%args);
    $cloud_job->insert();
...
Models::Object, Constants::General
